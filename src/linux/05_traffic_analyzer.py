...
class TrafficAnalyzer:
    ...
    def __init__(self):
        ...
        self.port_names = {
            ...
            993: 'IMAPS', 995: 'POP3S', 1194: 'OpenVPN', 1883: 'MQTT',
            3306: 'MySQL', 3389: 'RDP', 5060: 'SIP', 5061: 'SIPS',
            5353: 'mDNS', 5432: 'PostgreSQL', 6379: 'Redis',
            8080: 'HTTP-Alt', 8443: 'HTTPS-Alt', 8883: 'MQTT-TLS',
            # Streaming and common services
            554: 'RTSP', 1935: 'RTMP', 5228: 'Google-Play',
            19302: 'Google-STUN', 3478: 'STUN', 3479: 'STUN-Alt',
        }
